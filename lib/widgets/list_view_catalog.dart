              ...
              child: Stack(
                children: [
                  ...
                  Positioned(
                      ...
                      left: 160,
                      child: SizedBox(
                        child: Text(pancake.name, style: style7),
                      )),
                  Positioned(
                      top: 57,
                      left: 160,
                        ...
                        child: Stack(
                          children: [
                            Positioned(
                                top: 5,
                                left: 21,
                                child: Text(pancake.price, style: style5)),
                            Positioned(
                                top: 9,
                                left: 4,
                                child: Icon(Icons.currency_pound,
                                    color: KGreen.withOpacity(0.7), size: 18)),
                            Positioned(
                                top: 5,
                                right: 5,
                                child: Text('99', style: style6)),
                          ],
                        ),
                      )),
                  const Positioned(top: 45, right: 15, child: BtnGreen())
                ],
              ),
            ));
      });
